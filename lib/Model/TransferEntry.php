...
/**
 * TransferEntry Class Doc Comment
 *
 * @category Class
 * @package  BulkSMS
 * @author   OpenAPI Generator team
 ...
 */
class TransferEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransferEntry';
    ...
    protected static $openAPITypes = [
        ...
        'to_user_id' => 'float',
        'credits' => 'float',
        'comment_on_from' => 'string',
        'comment_on_to' => 'string'
    ];
    ...
    protected static $setters = [
        'to_username' => 'setToUsername',
        'to_user_id' => 'setToUserId',
        'credits' => 'setCredits',
        'comment_on_from' => 'setCommentOnFrom',
        'comment_on_to' => 'setCommentOnTo'
    ];
    ...
    protected static $getters = [
        'to_username' => 'getToUsername',
        'to_user_id' => 'getToUserId',
        'credits' => 'getCredits',
        'comment_on_from' => 'getCommentOnFrom',
        'comment_on_to' => 'getCommentOnTo'
    ];
    ...
    {
        $this->setIfExists('to_username', $data ?? [], null);
        $this->setIfExists('to_user_id', $data ?? [], null);
        $this->setIfExists('credits', $data ?? [], null);
        $this->setIfExists('comment_on_from', $data ?? [], null);
        $this->setIfExists('comment_on_to', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['to_username'] === null) {
            $invalidProperties[] = "'to_username' can't be null";
        }
    ...
    {
        return $this->container['to_username'];
    }

    /**
     * Sets to_username
     *
     * @param string $to_username The username of the account that will receive the credits.
     *
     * @return self
     */
    public function setToUsername($to_username)
    {
        if (is_null($to_username)) {
            throw new \InvalidArgumentException('non-nullable to_username cannot be null');
        }
        $this->container['to_username'] = $to_username;
     ...
     * Sets to_user_id
     *
     * @param float $to_user_id The numeric user ID of the account that will receive the credits. The ID must match the username.
     *
     * @return self
     */
     ...
     * Sets credits
     *
     * @param float $credits The amount of credits to transfer.
     *
     * @return self
     */
    ...
    /**
     * Gets comment_on_from
     *
     * @return string|null
     */
    public function getCommentOnFrom()
    {
        return $this->container['comment_on_from'];
    }

    /**
     * Sets comment_on_from
     *
     * @param string|null $comment_on_from An optional note that will be shown on the credit history of your account. The maximum length of the comment is 100.
     *
     * @return self
     */
    public function setCommentOnFrom($comment_on_from)
    {
        if (is_null($comment_on_from)) {
            throw new \InvalidArgumentException('non-nullable comment_on_from cannot be null');
        }
        $this->container['comment_on_from'] = $comment_on_from;
     ...
     * @return string|null
     */
    public function getCommentOnTo()
    {
        return $this->container['comment_on_to'];
    }

    /**
     * Sets comment_on_to
     *
     * @param string|null $comment_on_to An optional note that will be shown on the credit history of the recipient's account. The maximum length of the comment is 100.
     *
     * @return self
     */
    public function setCommentOnTo($comment_on_to)
    {
        if (is_null($comment_on_to)) {
            throw new \InvalidArgumentException('non-nullable comment_on_to cannot be null');
        }
        $this->container['comment_on_to'] = $comment_on_to;
