...
/**
 * ProfileQuota Class Doc Comment
 *
 * @category Class
 * @package  BulkSMS
 * @author   OpenAPI Generator team
 ...
 */
class ProfileQuota implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Profile_quota';
    ...
    */
     ...
     * Sets size
     *
     * @param int $size The setting that limits the number of messages you can send in a day.
     *
     * @return self
     */
     ...
     * Sets remaining
     *
     * @param int $remaining The number of messages you can still send today.
     *
     * @return self
     */
