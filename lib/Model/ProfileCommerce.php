 ...
 */
class ProfileCommerce implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Profile_commerce';
    ...
    protected static $setters = [
        'bank_payment_reference' => 'setBankPaymentReference',
        'address' => 'setAddress'
    ];
    ...
    protected static $getters = [
        'bank_payment_reference' => 'getBankPaymentReference',
        'address' => 'getAddress'
    ];
    ...
    {
        $this->setIfExists('bank_payment_reference', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets bank_payment_reference
     *
     * @return string|null
     */
    public function getBankPaymentReference()
    {
        return $this->container['bank_payment_reference'];
    }

    /**
     * Sets bank_payment_reference
     *
     * @param string|null $bank_payment_reference bank_payment_reference
     *
     * @return self
     */
    public function setBankPaymentReference($bank_payment_reference)
    {
        if (is_null($bank_payment_reference)) {
            throw new \InvalidArgumentException('non-nullable bank_payment_reference cannot be null');
        }
        $this->container['bank_payment_reference'] = $bank_payment_reference;
