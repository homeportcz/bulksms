...
/**
 * PreSignInfoFieldsInner Class Doc Comment
 *
 * @category Class
 * @package  BulkSMS
 * @author   OpenAPI Generator team
 ...
 */
class PreSignInfoFieldsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PreSignInfo_fields_inner';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The header name
     *
     * @return self
     */
