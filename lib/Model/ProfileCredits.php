...
/**
 * ProfileCredits Class Doc Comment
 *
 * @category Class
 * @package  BulkSMS
 * @author   OpenAPI Generator team
 ...
 */
class ProfileCredits implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Profile_credits';
    ...
    protected static $setters = [
        'balance' => 'setBalance',
        'limit' => 'setLimit',
        'is_transfer_allowed' => 'setIsTransferAllowed'
    ];
    ...
    protected static $getters = [
        'balance' => 'getBalance',
        'limit' => 'getLimit',
        'is_transfer_allowed' => 'getIsTransferAllowed'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_transfer_allowed', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets is_transfer_allowed
     *
     * @return bool|null
     */
    public function getIsTransferAllowed()
    {
        return $this->container['is_transfer_allowed'];
    }

    /**
     * Sets is_transfer_allowed
     *
     * @param bool|null $is_transfer_allowed is_transfer_allowed
     *
     * @return self
     */
    public function setIsTransferAllowed($is_transfer_allowed)
    {
        if (is_null($is_transfer_allowed)) {
            throw new \InvalidArgumentException('non-nullable is_transfer_allowed cannot be null');
        }
        $this->container['is_transfer_allowed'] = $is_transfer_allowed;
