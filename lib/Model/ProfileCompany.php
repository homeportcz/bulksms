...
/**
 * ProfileCompany Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProfileCompany implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Profile_company';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('tax_reference', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['tax_reference'];
    }

    /**
     * Sets tax_reference
     *
     * @param string|null $tax_reference tax_reference
     *
     * @return self
     */
    public function setTaxReference($tax_reference)
    {
        if (is_null($tax_reference)) {
            throw new \InvalidArgumentException('non-nullable tax_reference cannot be null');
        }
        $this->container['tax_reference'] = $tax_reference;
