...
/**
 * ProfileOriginAddresses Class Doc Comment
 *
 * @category Class
 * @package  BulkSMS
 * @author   OpenAPI Generator team
 ...
 */
class ProfileOriginAddresses implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Profile_originAddresses';
    ...
    protected static $setters = [
        'is_full_control_allowed' => 'setIsFullControlAllowed',
        'allowed' => 'setAllowed'
    ];
    ...
    protected static $getters = [
        'is_full_control_allowed' => 'getIsFullControlAllowed',
        'allowed' => 'getAllowed'
    ];
    ...
    {
        $this->setIfExists('is_full_control_allowed', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets is_full_control_allowed
     *
     * @return bool|null
     */
    public function getIsFullControlAllowed()
    {
        return $this->container['is_full_control_allowed'];
    }

    /**
     * Sets is_full_control_allowed
     *
     * @param bool|null $is_full_control_allowed is_full_control_allowed
     *
     * @return self
     */
    public function setIsFullControlAllowed($is_full_control_allowed)
    {
        if (is_null($is_full_control_allowed)) {
            throw new \InvalidArgumentException('non-nullable is_full_control_allowed cannot be null');
        }
        $this->container['is_full_control_allowed'] = $is_full_control_allowed;
