...
/**
 * SubmissionEntryToInner Class Doc Comment
 *
 * @category Class
 * @package  BulkSMS
 * @author   OpenAPI Generator team
 ...
 */
class SubmissionEntryToInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmissionEntry_to_inner';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Type of the recipient. The default value is INTERNATIONAL.
     *
     * @return self
     */
     ...
     * Sets address
     *
     * @param string|null $address The phone number of the recipient.  It must be supplied if the `type` is INTERNATIONAL
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of a group in your phonebook. A value can be given if the `type` is GROUP.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id The id of a group in your phonebook.  A value can be given if the `type` is GROUP.
     *
     * @return self
     */
     ...
     * Sets fields
     *
     * @param string[]|null $fields Custom fields that can be used in the message body. A value can be given if the `type` is INTERNATIONAL  Read the [body templates section](#tag/Message) for more information.
     *
     * @return self
     */
