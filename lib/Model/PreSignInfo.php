 ...
 */
class PreSignInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PreSignInfo';
    ...
    {
        $this->setIfExists('put_url', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['put_url'];
    }

    /**
     * Sets put_url
     *
     * @param string|null $put_url The address of the PUT request to upload the file.
     *
     * @return self
     */
    public function setPutUrl($put_url)
    {
        if (is_null($put_url)) {
            throw new \InvalidArgumentException('non-nullable put_url cannot be null');
        }
        $this->container['put_url'] = $put_url;
     ...
     * Sets fetch_url
     *
     * @param string|null $fetch_url The URL you use in your SMS text.  It is the file location.
     *
     * @return self
     */
