...
class MessageStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Message_status';
    ...
    public const SUBTYPE_EXPIRED = 'EXPIRED';
    public const SUBTYPE_HANDSET_ERROR = 'HANDSET_ERROR';
    public const SUBTYPE_BLOCKED = 'BLOCKED';
    public const SUBTYPE_NOT_SENT = 'NOT_SENT';
    ...
    {
        return [
            self::SUBTYPE_EXPIRED,
            self::SUBTYPE_HANDSET_ERROR,
            self::SUBTYPE_BLOCKED,
            self::SUBTYPE_NOT_SENT,
        ];
    }
    ...
    */
     ...
     * Sets id
     *
     * @param string $id A concatenated value A.B where A is the `status.type` and B is the `status.subtype`.   It there is no value for `subtype` then B takes string value `\"null\"` (e.g. `\"SENT.null\"`).
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type ACCEPTED  Message accepted for delivery. Only returned for initial message submissions.  SCHEDULED  Message accepted for delivery at a later date. Only returned for initial message  submissions.  SENT  Message has been relayed away from our systems.  DELIVERED  Successfully delivered to phone.  UNKNOWN  Message is in an unknown state.  FAILED  Delivery failed.
     *
     * @return self
     */
