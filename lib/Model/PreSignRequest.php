...
/**
 * PreSignRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PreSignRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PreSignRequest';
    ...
    */
     ...
     * Sets file_extension
     *
     * @param string|null $file_extension The extension of the file.  Usually related to the media type.
     *
     * @return self
     */
     ...
     * Sets media_type
     *
     * @param string|null $media_type The media type of the file you would like to upload.  If you are not sure what value to use here, check out the standard [list of media types](https://www.iana.org/assignments/media-types/media-types.xhtml).
     *
     * @return self
     */
