...
/**
 * MessageSubmission Class Doc Comment
 *
 * @category Class
 ...
 */
class MessageSubmission implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Message_submission';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id A unique identity shared by all messages that were created from the same submission. This field should be ignored if the `type` is not SENT.
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime $date The date and time the submission was processed. If the `type` is RECEIVED, this field reflects the date and time the received message was processed.
     *
     * @return self
     */
